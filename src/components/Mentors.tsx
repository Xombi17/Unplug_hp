    ...
    <section id="mentors" className="py-16 md:py-24 relative">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 font-magical px-4 py-1 bg-white/10 text-white border-sky-400/30">Our Team</Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="glass-card p-6 bg-black/40 border border-sky-400/30 rounded-lg backdrop-blur-md group hover:border-sky-400/60 transition-all">
            ...
            <p className="text-sky-400 mb-3">Innovation Specialist</p>
          ...
          <div className="glass-card p-6 bg-black/40 border border-sky-400/30 rounded-lg backdrop-blur-md group hover:border-sky-400/60 transition-all">
            ...
            <p className="text-sky-400 mb-3">Strategic Planning Expert</p>
            <p className="text-white/80">
          ...
          <div className="glass-card p-6 bg-black/40 border border-sky-400/30 rounded-lg backdrop-blur-md group hover:border-sky-400/60 transition-all">
            ...
            <p className="text-sky-400 mb-3">Networking Specialist</p>
            <p className="text-white/80">
        ...
        <div className="mt-12 text-center">
          ...
          <a href="#" className="font-magical inline-block py-3 px-6 rounded-lg border border-sky-400/50 text-sky-400 hover:bg-sky-400/10 transition-colors">
            View All Mentors
          </a>
        </div>
      </div>
