    ...
    <section id="features" className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <Badge variant="outline" className="mb-4 font-harry-potter px-4 py-1 bg-amber-900/30 text-amber-300 border-amber-400/30">Magical Services</Badge>
          <h2 className="font-harry-potter text-3xl md:text-5xl font-bold mb-6 text-white">
            <span className="text-amber-400">Enchanted</span> Offerings
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="parchment-card p-8 bg-gradient-to-b from-amber-900/40 to-amber-800/20 border border-amber-400/30 rounded-lg backdrop-blur-md group hover:border-amber-400/60 transition-all shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            <div className="w-14 h-14 rounded-full bg-amber-600/20 flex items-center justify-center mb-6 group-hover:bg-amber-600/40 transition-all border border-amber-500/30">
              <Users className="w-7 h-7 text-amber-400" />
            </div>
            <h3 className="text-xl font-harry-potter font-bold text-amber-300 mb-3">The Great Hall Gatherings</h3>
          ...
          <div className="parchment-card p-8 bg-gradient-to-b from-amber-900/40 to-amber-800/20 border border-amber-400/30 rounded-lg backdrop-blur-md group hover:border-amber-400/60 transition-all shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            ...
            <h3 className="text-xl font-harry-potter font-bold text-amber-300 mb-3">Defense Against Business Challenges</h3>
            <p className="text-white/80 font-serif">
          ...
          <div className="parchment-card p-8 bg-gradient-to-b from-amber-900/40 to-amber-800/20 border border-amber-400/30 rounded-lg backdrop-blur-md group hover:border-amber-400/60 transition-all shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            ...
            <h3 className="text-xl font-harry-potter font-bold text-amber-300 mb-3">The Potions Laboratory</h3>
            <p className="text-white/80 font-serif">
          ...
          <div className="parchment-card p-8 bg-gradient-to-b from-amber-900/40 to-amber-800/20 border border-amber-400/30 rounded-lg backdrop-blur-md group hover:border-amber-400/60 transition-all shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            ...
            <h3 className="text-xl font-harry-potter font-bold text-amber-300 mb-3">Gringotts Investment Vault</h3>
            <p className="text-white/80 font-serif">
          ...
          <div className="parchment-card p-8 bg-gradient-to-b from-amber-900/40 to-amber-800/20 border border-amber-400/30 rounded-lg backdrop-blur-md group hover:border-amber-400/60 transition-all shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            ...
            <h3 className="text-xl font-harry-potter font-bold text-amber-300 mb-3">Headmaster's Guidance</h3>
            <p className="text-white/80 font-serif">
          ...
          <div className="parchment-card p-8 bg-gradient-to-b from-amber-900/40 to-amber-800/20 border border-amber-400/30 rounded-lg backdrop-blur-md group hover:border-amber-400/60 transition-all shadow-[0_0_15px_rgba(245,158,11,0.2)]">
            ...
            <h3 className="text-xl font-harry-potter font-bold text-amber-300 mb-3">The Triwizard Business Cup</h3>
            <p className="text-white/80 font-serif">
