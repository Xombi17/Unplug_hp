  ...
  return (
    <section id="newsletter" className="py-16 md:py-24 relative">
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto glass-card p-8 md:p-12 bg-black/40 border border-amber-400/30 rounded-lg backdrop-blur-md">
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-3/5">
              <Badge variant="outline" className="mb-4 font-magical px-4 py-1 bg-white/10 text-white border-amber-400/30">Stay Connected</Badge>
              ...
              <div className="flex items-start space-x-4 mb-6">
                <div className="bg-amber-600/20 rounded-full p-2">
                  <Wand className="h-5 w-5 text-amber-400" />
                </div>
                <div>
            ...
            <div className="lg:w-2/5 w-full">
              <div className="bg-black/50 border border-amber-400/20 rounded-lg p-6">
                ...
                <form className="space-y-4">
                  ...
                  <div>
                    <Button className="w-full bg-gradient-to-r from-amber-600 to-amber-400 text-white">
                      Subscribe
                    </Button>
                  </div>
